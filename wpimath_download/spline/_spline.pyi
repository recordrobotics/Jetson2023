...
class Spline3:
    ...
    def getInitialControlVector(self) -> Spline3.ControlVector:
        ...
        :returns: The initial control vector that created this spline.
        """
    def getPoint(self, t: float) -> tuple[wpimath_download.geometry._geometry.Pose2d, wpimath_download.units.radians_per_meter]:
        """
...
class SplineHelper:
    ...
    """
    @staticmethod
    def cubicControlVectorsFromWaypoints(start: wpimath_download.geometry._geometry.Pose2d, interiorWaypoints: list[wpimath_download.geometry._geometry.Translation2d], end: wpimath_download.geometry._geometry.Pose2d) -> tuple[Spline3.ControlVector, Spline3.ControlVector]:
        """
        ...
        """
    @staticmethod
    def cubicSplinesFromControlVectors(start: Spline3.ControlVector, waypoints: list[wpimath_download.geometry._geometry.Translation2d], end: Spline3.ControlVector) -> list[CubicHermiteSpline]:
        """
    ...
    def quinticSplinesFromControlVectors(controlVectors: list[Spline5.ControlVector]) -> list[QuinticHermiteSpline]:
        ...
        """
    @staticmethod
    def quinticSplinesFromWaypoints(waypoints: list[wpimath_download.geometry._geometry.Pose2d]) -> list[QuinticHermiteSpline]:
        """
...
class SplineParameterizer:
    ...
    @staticmethod
    @typing.overload
    def parameterize(spline: Spline3, t0: float = 0.0, t1: float = 1.0) -> list[tuple[wpimath_download.geometry._geometry.Pose2d, wpimath_download.units.radians_per_meter]]:
        """
    ...
    @staticmethod
    @typing.overload
    def parameterize(spline: Spline5, t0: float = 0.0, t1: float = 1.0) -> list[tuple[wpimath_download.geometry._geometry.Pose2d, wpimath_download.units.radians_per_meter]]:
        """
        Parametrizes the spline. This method breaks up the spline into various
        arcs until their dx, dy, and dtheta are within specific tolerances.
