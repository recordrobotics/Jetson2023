...
import numpy
import typing
import wpimath_download._controls._controls.controller
import wpimath_download._controls._controls.estimator
...
class LinearSystemLoop_1_1_1:
    ...
    def U(self, i: int) -> float:
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_1_1_1, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_1_1, observer: wpimath_download._controls._controls.estimator.KalmanFilter_1_1_1, maxVoltage: wpimath_download.units.volts, dt: wpimath_download.units.seconds) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_1_1_1, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_1_1, observer: wpimath_download._controls._controls.estimator.KalmanFilter_1_1_1, clampFunction: typing.Callable[[numpy.ndarray[numpy.float64[1, 1]]], numpy.ndarray[numpy.float64[1, 1]]], dt: wpimath_download.units.seconds) -> None:
        """
        Constructs a state-space loop with the given plant, controller, and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state before enabling the loop. This
        ...
        """
    @typing.overload
    def __init__(self, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_1_1, feedforward: wpimath_download._controls._controls.controller.LinearPlantInversionFeedforward_1_1, observer: wpimath_download._controls._controls.estimator.KalmanFilter_1_1_1, maxVoltage: wpimath_download.units.volts) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_1_1, feedforward: wpimath_download._controls._controls.controller.LinearPlantInversionFeedforward_1_1, observer: wpimath_download._controls._controls.estimator.KalmanFilter_1_1_1, clampFunction: typing.Callable[[numpy.ndarray[numpy.float64[1, 1]]], numpy.ndarray[numpy.float64[1, 1]]]) -> None:
        """
    ...
    def nextR(self, i: int) -> float:
        ...
        :param i: Row of r.
        """
    def predict(self, dt: wpimath_download.units.seconds) -> None:
        """
...
class LinearSystemLoop_2_1_1:
    ...
    def U(self, i: int) -> float:
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_2_1_1, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_2_1, observer: wpimath_download._controls._controls.estimator.KalmanFilter_2_1_1, maxVoltage: wpimath_download.units.volts, dt: wpimath_download.units.seconds) -> None:
        """
        Constructs a state-space loop with the given plant, controller, and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state before enabling the loop. This
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_2_1_1, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_2_1, observer: wpimath_download._controls._controls.estimator.KalmanFilter_2_1_1, clampFunction: typing.Callable[[numpy.ndarray[numpy.float64[1, 1]]], numpy.ndarray[numpy.float64[1, 1]]], dt: wpimath_download.units.seconds) -> None:
        """
        Constructs a state-space loop with the given plant, controller, and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state before enabling the loop. This
        ...
        """
    @typing.overload
    def __init__(self, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_2_1, feedforward: wpimath_download._controls._controls.controller.LinearPlantInversionFeedforward_2_1, observer: wpimath_download._controls._controls.estimator.KalmanFilter_2_1_1, maxVoltage: wpimath_download.units.volts) -> None:
        """
        Constructs a state-space loop with the given controller, feedforward and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state.
...
class LinearSystemLoop_2_2_2:
    ...
    def U(self, i: int) -> float:
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_2_2_2, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_2_2, observer: wpimath_download._controls._controls.estimator.KalmanFilter_2_2_2, maxVoltage: wpimath_download.units.volts, dt: wpimath_download.units.seconds) -> None:
        """
        Constructs a state-space loop with the given plant, controller, and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state before enabling the loop. This
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_2_2_2, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_2_2, observer: wpimath_download._controls._controls.estimator.KalmanFilter_2_2_2, clampFunction: typing.Callable[[numpy.ndarray[numpy.float64[2, 1]]], numpy.ndarray[numpy.float64[2, 1]]], dt: wpimath_download.units.seconds) -> None:
        """
        Constructs a state-space loop with the given plant, controller, and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state before enabling the loop. This
        ...
        """
    @typing.overload
    def __init__(self, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_2_2, feedforward: wpimath_download._controls._controls.controller.LinearPlantInversionFeedforward_2_2, observer: wpimath_download._controls._controls.estimator.KalmanFilter_2_2_2, maxVoltage: wpimath_download.units.volts) -> None:
        """
        Constructs a state-space loop with the given controller, feedforward and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state.
        ...
        """
    @typing.overload
    def __init__(self, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_2_2, feedforward: wpimath_download._controls._controls.controller.LinearPlantInversionFeedforward_2_2, observer: wpimath_download._controls._controls.estimator.KalmanFilter_2_2_2, clampFunction: typing.Callable[[numpy.ndarray[numpy.float64[2, 1]]], numpy.ndarray[numpy.float64[2, 1]]]) -> None:
        """
        Constructs a state-space loop with the given controller, feedforward,
        observer and clamp function. By default, the initial reference is all
        zeros. Users should call reset with the initial system state.
...
class LinearSystemLoop_3_2_3:
    ...
    def U(self, i: int) -> float:
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_3_2_3, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_3_2, observer: wpimath_download._controls._controls.estimator.KalmanFilter_3_2_3, maxVoltage: wpimath_download.units.volts, dt: wpimath_download.units.seconds) -> None:
        """
        Constructs a state-space loop with the given plant, controller, and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state before enabling the loop. This
        ...
        """
    @typing.overload
    def __init__(self, plant: LinearSystem_3_2_3, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_3_2, observer: wpimath_download._controls._controls.estimator.KalmanFilter_3_2_3, clampFunction: typing.Callable[[numpy.ndarray[numpy.float64[2, 1]]], numpy.ndarray[numpy.float64[2, 1]]], dt: wpimath_download.units.seconds) -> None:
        """
        Constructs a state-space loop with the given plant, controller, and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state before enabling the loop. This
        ...
        """
    @typing.overload
    def __init__(self, controller: wpimath_download._controls._controls.controller.LinearQuadraticRegulator_3_2, feedforward: wpimath_download._controls._controls.controller.LinearPlantInversionFeedforward_3_2, observer: wpimath_download._controls._controls.estimator.KalmanFilter_3_2_3, maxVoltage: wpimath_download.units.volts) -> None:
        """
        Constructs a state-space loop with the given controller, feedforward and
        observer. By default, the initial reference is all zeros. Users should
        call reset with the initial system state.
...
class LinearSystem_1_1_1:
    ...
    def __init__(self, A: numpy.ndarray[numpy.float64[1, 1]], B: numpy.ndarray[numpy.float64[1, 1]], C: numpy.ndarray[numpy.float64[1, 1]], D: numpy.ndarray[numpy.float64[1, 1]]) -> None:
        ...
        """
    def calculateX(self, x: numpy.ndarray[numpy.float64[1, 1]], clampedU: numpy.ndarray[numpy.float64[1, 1]], dt: wpimath_download.units.seconds) -> numpy.ndarray[numpy.float64[1, 1]]:
        """
...
class LinearSystem_2_1_1:
    ...
    def __init__(self, A: numpy.ndarray[numpy.float64[2, 2]], B: numpy.ndarray[numpy.float64[2, 1]], C: numpy.ndarray[numpy.float64[1, 2]], D: numpy.ndarray[numpy.float64[1, 1]]) -> None:
        ...
        :param D: Feedthrough matrix.
                  @throws std::domain_error if any matrix element isn't finite.
        """
    def calculateX(self, x: numpy.ndarray[numpy.float64[2, 1]], clampedU: numpy.ndarray[numpy.float64[1, 1]], dt: wpimath_download.units.seconds) -> numpy.ndarray[numpy.float64[2, 1]]:
        """
        Computes the new x given the old x and the control input.
...
class LinearSystem_2_2_1:
    ...
    def __init__(self, A: numpy.ndarray[numpy.float64[2, 2]], B: numpy.ndarray[numpy.float64[2, 2]], C: numpy.ndarray[numpy.float64[1, 2]], D: numpy.ndarray[numpy.float64[1, 2]]) -> None:
        ...
        :param D: Feedthrough matrix.
                  @throws std::domain_error if any matrix element isn't finite.
        """
    def calculateX(self, x: numpy.ndarray[numpy.float64[2, 1]], clampedU: numpy.ndarray[numpy.float64[2, 1]], dt: wpimath_download.units.seconds) -> numpy.ndarray[numpy.float64[2, 1]]:
        """
        Computes the new x given the old x and the control input.
...
class LinearSystem_3_2_1:
    ...
    def __init__(self, A: numpy.ndarray[numpy.float64[3, 3]], B: numpy.ndarray[numpy.float64[3, 2]], C: numpy.ndarray[numpy.float64[1, 3]], D: numpy.ndarray[numpy.float64[1, 2]]) -> None:
        ...
        :param D: Feedthrough matrix.
                  @throws std::domain_error if any matrix element isn't finite.
        """
    def calculateX(self, x: numpy.ndarray[numpy.float64[3, 1]], clampedU: numpy.ndarray[numpy.float64[2, 1]], dt: wpimath_download.units.seconds) -> numpy.ndarray[numpy.float64[3, 1]]:
        """
        Computes the new x given the old x and the control input.
