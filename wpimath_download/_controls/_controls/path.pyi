...
class TravelingSalesman:
    ...
    def __init__(self) -> None:
        ...
        """
    @typing.overload
    def __init__(self, cost: typing.Callable[[wpimath_download.geometry._geometry.Pose2d, wpimath_download.geometry._geometry.Pose2d], float]) -> None:
        """
        ...
        """
    def solve(self, poses: list[wpimath_download.geometry._geometry.Pose2d], iterations: int) -> list[wpimath_download.geometry._geometry.Pose2d]:
        """
