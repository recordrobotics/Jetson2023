...
class Debouncer:
    ...
    class DebounceType:
        ...
        def value(self) -> int:
            ...
    def __init__(self, debounceTime: wpimath_download.units.seconds, type: Debouncer.DebounceType = ...) -> None:
        """
...
class LinearFilter:
    ...
    """
    @staticmethod
    def highPass(timeConstant: float, period: wpimath_download.units.seconds) -> LinearFilter:
        """
    ...
    def movingAverage(taps: int) -> LinearFilter:
        ...
        """
    @staticmethod
    def singlePoleIIR(timeConstant: float, period: wpimath_download.units.seconds) -> LinearFilter:
        """
...
class SlewRateLimiter:
    ...
    """
    @typing.overload
    def __init__(self, positiveRateLimit: wpimath_download.units.units_per_second, negativeRateLimit: wpimath_download.units.units_per_second, initialValue: float = 0.0) -> None:
        """
        ...
        """
    @typing.overload
    def __init__(self, rateLimit: wpimath_download.units.units_per_second) -> None:
        """
