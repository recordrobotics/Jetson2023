...
class AprilTag:
    ...
    def ID(self, arg0: int) -> None:
        ...
    @property
    def pose(self) -> wpimath_download.geometry._geometry.Pose3d:
        """
        The tag's pose.
        """
    @pose.setter
    def pose(self, arg0: wpimath_download.geometry._geometry.Pose3d) -> None:
        ...
...
class AprilTagDetector:
    ...
    class QuadThresholdParameters:
        ...
        def __init__(self) -> None:
            ...
        @property
        def criticalAngle(self) -> wpimath_download.units.radians:
            """
        ...
        def criticalAngle(self, arg0: wpimath_download.units.radians) -> None:
            ...
        @property
...
class AprilTagFieldLayout:
    ...
    def __init__(self, path: str) -> None:
        ...
        """
    @typing.overload
    def __init__(self, apriltags: list[AprilTag], fieldLength: wpimath_download.units.meters, fieldWidth: wpimath_download.units.meters) -> None:
        """
        ...
        """
    def getFieldLength(self) -> wpimath_download.units.meters:
        """
        Returns the length of the field the layout is representing.
        
        :returns: length
        """
    def getFieldWidth(self) -> wpimath_download.units.meters:
        """
        Returns the length of the field the layout is representing.
        
        :returns: width
        """
    def getOrigin(self) -> wpimath_download.geometry._geometry.Pose3d:
        """
        Returns the origin used for tag pose transformation.
        
        :returns: the origin
        """
    def getTagPose(self, ID: int) -> wpimath_download.geometry._geometry.Pose3d | None:
        """
    ...
    def setOrigin(self, origin: AprilTagFieldLayout.OriginPosition) -> None:
        ...
        """
    @typing.overload
    def setOrigin(self, origin: wpimath_download.geometry._geometry.Pose3d) -> None:
        """
...
class AprilTagPoseEstimate:
    ...
    def error2(self, arg0: float) -> None:
        ...
    @property
    def pose1(self) -> wpimath_download.geometry._geometry.Transform3d:
        """
        Pose 1.
        """
    @pose1.setter
    def pose1(self, arg0: wpimath_download.geometry._geometry.Transform3d) -> None:
        ...
    @property
    def pose2(self) -> wpimath_download.geometry._geometry.Transform3d:
        """
        Pose 2.
        """
    @pose2.setter
    def pose2(self, arg0: wpimath_download.geometry._geometry.Transform3d) -> None:
        ...
class AprilTagPoseEstimator:
    ...
    class Config:
        ...
        def __eq__(self, arg0: AprilTagPoseEstimator.Config) -> bool:
            ...
        def __init__(self, tagSize: wpimath_download.units.meters, fx: float, fy: float, cx: float, cy: float) -> None:
            ...
        @property
        def cx(self) -> float:
            """
        ...
        def fy(self, arg0: float) -> None:
            ...
        @property
        def tagSize(self) -> wpimath_download.units.meters:
            """
            The tag size.
            """
        @tagSize.setter
        def tagSize(self, arg0: wpimath_download.units.meters) -> None:
            ...
    def __init__(self, config: AprilTagPoseEstimator.Config) -> None:
        ...
        """
    @typing.overload
    def estimate(self, detection: AprilTagDetection) -> wpimath_download.geometry._geometry.Transform3d:
        """
        ...
        """
    @typing.overload
    def estimate(self, homography: tuple[float, float, float, float, float, float, float, float, float], corners: tuple[float, float, float, float, float, float, float, float]) -> wpimath_download.geometry._geometry.Transform3d:
        """
        Estimates tag pose. This method is an easier to use interface to
        EstimatePoseOrthogonalIteration(), running 50 iterations and returning the
        pose with the lower object-space error.
        ...
        """
    @typing.overload
    def estimateHomography(self, detection: AprilTagDetection) -> wpimath_download.geometry._geometry.Transform3d:
        """
        ...
        """
    @typing.overload
    def estimateHomography(self, homography: tuple[float, float, float, float, float, float, float, float, float]) -> wpimath_download.geometry._geometry.Transform3d:
        """
        Estimates the pose of the tag using the homography method described in [1].
